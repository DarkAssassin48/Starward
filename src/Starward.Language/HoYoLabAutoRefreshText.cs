...
/// Values are stored in the existing Lang*.resx language packs.
/// </summary>
public static class HoYoLabAutoRefreshText
{
    ...
    public static string Description => Get("HoyolabAutoRefresh_Description", "Choose how often Starward refreshes saved HoYoLAB Toolbox data for each game.");
    ...
    public static string ScheduleNote => Get("HoyolabAutoRefresh_ScheduleNote", "Scheduled refreshes run while Starward is open.");
    ...
    {
        return Lang.ResourceManager.GetString(key, CurrentCulture) ?? fallback;
    }
